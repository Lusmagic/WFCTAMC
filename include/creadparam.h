...
public:
   ...
   int GetFadcBins();
   int GetFadcLength();
   float GetNSB(int ict);
   float GetInnerFixTriggerThreshold(int ict);
   float GetOuterFixTriggerThreshold(int ict);
   int GetNSBFlag();
   float GetTriggerSigma(int ict);
   int GetWLFormat();
   int GetAtmModel();
   float GetAltitude();
