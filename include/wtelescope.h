...
class WTelescope
{
  private:
    ...
    double Xup[3], Xdown[3],Yup[3], Ydown[3],Zup[3], Zdown[3];
    double Xleft[3], Yleft[3], Zleft[3], Xright[3], Yright[3], Zright[3];
  public:
    WTelescope();
    ~WTelescope();
    ...
    void SetTransmissivity(int ict);   //added by lingling Ma 2018.1.10
    void SetReflectivity(int ict);
    ...
    void SetPlanePoints();
    double SetPlane( double *X, double *Y, double *Z, double m, double n, double l, double x0, double y0,double z0, double *x, double *y, double *z);
};
